...
const PI = 3.14;
console.log("The value of PI is: ", ____);
// # Below are some different data types of variables. Try to print out the data types of each variable below. Hint: use the typeof operator.
let myNum = 15;
